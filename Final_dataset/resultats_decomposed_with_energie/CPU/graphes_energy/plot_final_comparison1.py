...
class Args:
    ...
    csv_path = script_dir / "all_configs_combined_summary.csv"
...
def main(args):
    ...
    if not csv_path.is_file():
        raise FileNotFoundError(
            ...
            " fichier all_configs_combined_summary.csv "
            ""
        )
    ...
    grouped_bar(
        ...
        title="Total Energy Consumption per Configuration and Delay",
        out_prefix="total_energy_per_delay",
        args=args,
    )
    ...
    grouped_bar(
        ...
        title="Energy per Invocation per Configuration and Delay",
        out_prefix="energy_per_invocation",
        args=args,
    )
    ...
    grouped_bar(
        ...
        ylabel="Max Power (W)",
        title="Peak Power Consumption per Configuration and Delay",
        out_prefix="max_power_per_delay",
        args=args,
    )
