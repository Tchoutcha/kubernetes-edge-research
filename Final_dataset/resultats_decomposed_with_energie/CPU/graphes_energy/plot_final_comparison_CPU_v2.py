...
def main(args):
    ...
    grouped_bar(
        ...
        title="Total Energy Consumption per Configuration and Delay (CPU)",
    ...
    grouped_bar(
        ...
        title="Energy per Invocation per Configuration and Delay (CPU)",
    ...
    grouped_bar(
        ...
        ylabel="Max Power (W)",
        title="Peak Power Consumption per Configuration and Delay (CPU)",
