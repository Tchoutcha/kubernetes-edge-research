...
class Args:
    ...
    csv_path = script_dir / "MIXED_all_configs_with10s_FINAL.csv"
    out_dir = script_dir / "figures_MIXED_v2"

    delay_order = ["10ms", "50ms", "100ms", "200ms", "1s", "10s"]
...
def main(args):
    ...
    grouped_bar(
        ...
        title="Total Energy Consumption per Configuration and Delay (Mixed ML+CPU)",
        out_prefix="total_energy_per_delay_MIXED",
        args=args,
    )
    ...
    grouped_bar(
        ...
        title="Energy per Invocation per Configuration and Delay (Mixed ML+CPU)",
        out_prefix="energy_per_invocation_MIXED",
        args=args,
    )
    ...
    grouped_bar(
        ...
        ylabel="Max Power (W)",
        title="Peak Power Consumption per Configuration and Delay (Mixed ML+CPU)",
        out_prefix="max_power_per_delay_MIXED",
        args=args,
    )
