...
kubectl logs -f -n kube-system my-scheduler-668bffc96f-rg9mp >> "$SCHEDULER_LOG" 2>&1 &
kubectl logs -f -n kourier-system  3scale-kourier-gateway-565f9bb47c-wmhr9 > kourier.txt
